...
<main>
    ...
    <section>
        ...
        <p>
        <ul>
            <li>Die Veranstaltung ist eine <strong>Trainings</strong>veranstaltung und die Wertung dient nur zur Bestimmung der eigenen Fitness.</li>
    ...
    <section>
        ...
        <p>Die geplante Strecke im Detail findest Du <a href="https://www.alltrails.com/explore/map/main-taunus-ezf?u=m" target="_blank"> hier >></a></p>
        <p>Streckenübersicht</p>
        <img src="<?= DIR ?>static/img/course/course_overview.png" alt="Strecke">
        <p>
